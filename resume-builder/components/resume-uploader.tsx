...
>(({ setJsonData }, ref) => {
  ...
  "basics": {
    ...
    "summary": "Fullstack Developer passionate about building solutions that solve real-world challenges. With a background in IoT and software development, I enjoy solving ideas into user-friendly tools.",
    "location": {
      "address": "St.Gallen"
    },
    "profiles": [
  ...
  "work": [
    {
      ...
      "description": "Global leader in food processing, Annual turnover: CHF 2.9 billion",
      ...
      "highlights": [
        ...
        "Contributing to Bühler's internal AI Chatbot Solution used by over 2'000 people monthly.",
